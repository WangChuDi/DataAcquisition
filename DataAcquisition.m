classdef DataAcquisition < handle
    ...
    methods (Hidden=true)
        ...
        function normalMode(obj)
            modes.NormalMode.activate(obj);
        end

        function normalSizing(obj)
            modes.NormalMode.sizing(obj);
        end

        function normalResizeFcn(obj)
            modes.NormalMode.resize(obj);
        end
        ...
        function noiseMode(obj)
            modes.NoiseMode.activate(obj);
        end

        function noiseSizing(obj)
            modes.NoiseMode.sizing(obj);
        end

        function noiseResizeFcn(obj)
            modes.NoiseMode.resize(obj);
        end

        function ivMode(obj)
            modes.IvMode.activate(obj);
        end

        function ivSizing(obj)
            modes.IvMode.sizing(obj);
        end

        function ivResizeFcn(obj)
            modes.IvMode.resize(obj);
        end

        function sealtestMode(obj)
            modes.SealtestMode.activate(obj);
        end

        function sealtestSizing(obj)
            modes.SealtestMode.sizing(obj);
        end

        function sealtestResizeFcn(obj)
            modes.SealtestMode.resize(obj);
        end

        function freqrespMode(obj)
            modes.FreqrespMode.activate(obj);
        end

        function freqrespSizing(obj)
            modes.FreqrespMode.sizing(obj);
        end

        function freqrespResizeFcn(obj)
            modes.FreqrespMode.resize(obj);
        end
